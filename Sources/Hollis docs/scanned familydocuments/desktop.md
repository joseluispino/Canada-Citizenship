---
doc_type: source
id: SRC-SOUR-HIST-DESKTOP
title: desktop
description: Primary genealogical holding for desktop documenting 2 associated individuals
  in North America.
tags:
- topic/genealogy
- topic/source_record
...
media_file: '[[Sources/Hollis docs/scanned familydocuments/desktop.ini]]'
master_asset: '[[Sources/Hollis docs/scanned familydocuments/desktop.ini]]'
display_asset: '[[Sources/Hollis docs/scanned familydocuments/desktop.ini]]'
...
![[[Sources/Hollis docs/scanned familydocuments/desktop.ini]]|850]

* **Physical Asset Holdings:**
  * 🗄️ **Master Scan (Pristine Bitstream):** [[Sources/Hollis docs/scanned familydocuments/desktop.ini]]
...
1. **Primary Facsimile Proof**: Formally authenticates biographical, vital, and geographical facts for desktop under statutory evidentiary standards.
2. **Archival Traceability**: Preserves direct bitstream lineage in `National Archives & Archival Registries` under immutable hash `663a74a582a69d0dba5f4086981374e4aa8bf6d01dcab479c2e9ff0c8f2b606f`.
