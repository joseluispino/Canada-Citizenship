...
flowchart TD
    ...
    subgraph Corroborating_Empirical_Scans_In_Vault_Today ["Corroborating Empirical Scans (In-Vault Today)"]
        ...
        C4["📄 1898 Birth Cert (Maine Vital Vol 1898-W p. 314)<br/><b>Certifies Father b. Canada</b>"]
        C5["🇺🇸 1900 US Census (Calais ME, Sheet 6A)<br/><b>John W. Whalen b. Aug 1860 in Canada</b>"]
    end

    B1 -.->|Reinforces Statutory Proof| C1
    C1 --- C2 --- C3 --- C4 --- C5
```
