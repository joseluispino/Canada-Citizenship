---
doc_type: central_dashboard
title: Canadian Citizenship Proof & Sovereign Deliverable Portal
tags:
  - type/dashboard
  - topic/citizenship
  - status/verified
...
graph LR
    ...
    classDef active fill:#0d47a1,stroke:#1565c0,color:#fff;
    classDef next fill:#424242,stroke:#616161,color:#fff;

    P1["<b>Phase 1: Evidentiary Audit</b><br/>Preponderance Matrix & Naturalization Audit Complete"]:::done
    P2["<b>Phase 2: Archival Certified Orders</b><br/>Dispatch PANB & LAC Orders with Attached Reference Scans"]:::active
    P3["<b>Phase 3: Form CIT 0001 Completion</b><br/>Complete Application per Filing Guide & Pay $75 CAD Fee"]:::next
    P4["<b>Phase 4: Official Submission</b><br/>Courier Final Application Binder to CPC-Sydney"]:::next
